...
namespace ClassifierApp
{
    ...
    {
        /// <summary>
        /// model input class for ClassifierAppMLModel.
        /// </summary>
        ...
        /// <summary>
        /// model output class for ClassifierAppMLModel.
        /// </summary>
        ...
        private static string MLNetModelPath = Path.GetFullPath("ClassifierAppMLModel.mlnet");
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("Categoria");
            if (labelColumn == null)
            {
                throw new Exception("Categoria column not found. Make sure the name searched for matches the name in the schema.");
            }
